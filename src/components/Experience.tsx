          ...
          {experiences.slice(0, showAll ? experiences.length : 3).map((experience, index) => (
            ...
            >
              ...
              <div className="flex items-start gap-8 mb-12 relative z-10">
                <div className={`flex-shrink-0 w-16 h-16 rounded-full flex items-center justify-center border-4 transition-all duration-150 ${
                  experience.isActive 
                ...
                <div className="flex-1 bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-border/50 hover:border-primary/20 transition-all duration-150 hover:scale-[1.02]">
